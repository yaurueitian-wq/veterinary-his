...
| [ADR-012](#adr-012-就診狀態轉換歷史) | 就診狀態轉換歷史 | ✅ 已實作 | 2026-03-06 |
...
| [ADR-016](#adr-016-系統小幫手-ai-assistant-架構) | 系統小幫手（AI Assistant）架構 | ✅ 已實作 | 2026-03-07 |
...
**狀態**：✅ 已實作（visit_status_history 表，migration 0004）
...
**狀態**：✅ 已實作（Ollama llama3.2:3b，唯讀工具白名單，稽核記錄）
